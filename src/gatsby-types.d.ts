...
type BioQueryQuery = { readonly site: { readonly siteMetadata: { readonly author: { readonly name: string | null, readonly summary: string | null } | null, readonly social: { readonly github: string | null, readonly medium: string | null } | null } | null } | null };
